...
To learn how to use Grok vision for more advanced use cases, check out our [Chat Responses - Image understanding](guides/chat#image-understanding).
...
The advanced agentic search capabilities powering grok.com are generally available in the new [**agentic tool calling API**](/docs/guides/tools/overview), and the Live Search API will be deprecated by January 12, 2026.
